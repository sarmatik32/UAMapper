  ...
  return (
    <div className={`w-full md:w-80 flex flex-col h-full overflow-hidden z-20 font-sans border-t md:border-t-0 ${
      ...
      <div className={`p-4 border-b flex justify-between items-center ${
        ...
        <div className={`px-3 py-1.5 rounded-full border flex flex-nowrap items-center gap-1.5 sm:gap-2 shadow-md transition-all select-none ${
          theme === 'light' 
            ? 'bg-slate-950/90 border-slate-900 text-white' 
            : 'bg-white/90 border-white text-slate-950'
        }`}>
          <span 
            className="font-sans font-bold tracking-tight text-[12px] sm:text-[14px] leading-none flex items-center"
            style={{ color: theme === 'light' ? 'rgb(225, 255, 0)' : 'rgb(255, 0, 0)' }}
          >
            UA Mapper
          </span>
          <span className={`inline-block w-[1px] h-3.5 mx-0.5 self-center ${
            theme === 'light' ? 'bg-white/20' : 'bg-slate-950/20'
          }`} />
          <span className={`font-sans font-bold tracking-wider uppercase leading-none flex items-center text-[9px] sm:text-[10px] ${
            theme === 'light' ? 'text-white' : 'text-slate-950'
          }`}>
            BY @KRRIG_ALERTS
          </span>
          <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 ml-0.5 flex-shrink-0 animate-pulse" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <linearGradient id="telegram-watermark-gradient-sidebar" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" stopColor="#2AABEE" />
                <stop offset="100%" stopColor="#229ED9" />
              </linearGradient>
            </defs>
            <circle cx="14" cy="14" r="13" fill="url(#telegram-watermark-gradient-sidebar)" />
        ...
        <div className="flex items-center gap-1.5">
          ...
          >
            <Globe className="w-4 h-4 text-slate-500 hover:text-slate-700 dark:text-slate-400 dark:hover:text-slate-200" />
          </button>
        </div>
      </div>
      ...
      <div className={`p-4 border-t space-y-3 ${
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <button
            onClick={onExportPNG}
            className={`w-full py-3 font-extrabold text-xs rounded-xl active:scale-[0.97] hover:scale-[1.01] transition-all cursor-pointer flex items-center justify-center gap-1.5 border shadow-md ${
              theme === 'light'
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <button
            onClick={onUndo}
            className={`w-full py-3 font-bold text-xs rounded-xl active:scale-[0.97] hover:scale-[1.01] transition-all cursor-pointer flex items-center justify-center gap-1.5 border ${
              theme === 'light'
          ...
          <button
            ...
            className="w-full py-3 bg-red-600 hover:bg-red-500 active:scale-[0.97] hover:scale-[1.01] text-white font-extrabold text-xs rounded-xl shadow-lg shadow-red-600/10 transition-all cursor-pointer flex items-center justify-center gap-1.5 border border-red-500/10"
          >
